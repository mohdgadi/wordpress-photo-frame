...
<main id="site-main">
	...
	<div class="site-page-content">
		<div class="site-section-wrapper site-section-wrapper-main clearfix">
			...
			<h1 class="page-title"><?php esc_html_e( 'Page not found', 'photoframe' ); ?></h1>

			<div class="archives-content clearfix"><p><?php esc_html_e( 'Apologies, but the requested page cannot be found. Perhaps searching will help find a related page.', 'photoframe' ); ?></p></div>
			<hr />
			<?php get_search_form(); ?>
